...
%
% NOTE: 
%   Hardware selection (Ganymede vs Gan632) is based on the system loaded by yOCTHardwareLibSetUp().
%   yOCTHardwareLibSetUp() needs to be called before using this function.
    ...
    for attempt = 1:numRetries
        try
            ...
            switch(octSystemName)
                ...
                otherwise
                    % Should never reach here: yOCTHardware('status') validates system before this point.
