classdef test_yOCTSimulateTileScan < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function testLoadSaveNoStitchingWithWrongFocus(testCase)
            ...
            % Crop window: 5 sigma around focus (z=0), so the in/out focus
            % comparison is not diluted by the rest of the Z range.
            focusHalfWindow_mm = 5 * focusSigma * pixel_size_um * 1e-3;
            ...
            yOCTProcessTiledScan(...
                ...
                'dispersionQuadraticTerm',0, ... Use 0 as simulated data doesn't have dispersion
                'interpMethod','sinc5', ...
                'cropZRange_mm', [-focusHalfWindow_mm, focusHalfWindow_mm] ...
                );
        ...
        function testLoadSaveWithStitching(testCase)
            ...
            yOCTProcessTiledScan(...
                ...
                'dispersionQuadraticTerm',0, ... Use 0 as simulated data doesn't have dispersion
                'interpMethod','sinc5', ...
                'cropZRange_mm', [zDepths_mm(1), zDepths_mm(end)], ... Crop to the scanned depth range
